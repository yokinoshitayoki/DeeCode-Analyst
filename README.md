...
DeepCode-Analyst 是一个先进的代码分析系统，结合了**知识图谱**、**多智能体系统**和**大语言模型微调**技术，能够：

- 🔍 **自动代码解析**：使用 tree-sitter 解析多种编程语言
- 🕸️ **知识图谱构建**：基于 NetworkX 构建代码结构关系图
- 🤖 **多智能体协作**：使用 LangGraph 实现任务分解和智能协作
...
- [🌳 tree-sitter](https://tree-sitter.github.io/) - 增量语法解析器
- [🕸️ NetworkX](https://networkx.org/) - 图论和网络分析
- [🦜 LangChain](https://langchain.com/) - LLM 应用开发框架
- [🤗 Transformers](https://huggingface.co/transformers/) - 预训练模型库
- [⚡ Qwen](https://github.com/QwenLM/Qwen) - 强大的基础语言模型

## 📞 联系方式

- **项目主页**: [https://github.com/yokinoshitayoki/DeeCode-Analyst](https://github.com/yokinoshitayoki/DeeCode-Analyst)
- **问题反馈**: [GitHub Issues](https://github.com/yokinoshitayoki/DeeCode-Analyst/issues)
- **讨论交流**: [GitHub Discussions](https://github.com/yokinoshitayoki/DeeCode-Analyst/discussions)
